...
func TestUnElemento(t *testing.T) {
	t.Log("Comprueba que ABB con un elemento tiene esa Clave, únicamente")
...
func TestABBAgregar(t *testing.T) {
	t.Log("Guarda algunos elementos en el ABB y se comprueba que en todo momento funciona acorde")
	clave1 := "Gato"
	clave2 := "Perro"
	clave3 := "Vaca"
	valor1 := "miau"
...
func TestABBBorrar(t *testing.T) {
	t.Log("Guarda algunos pocos elementos en el ABB, y se los borra, revisando que el ABB se comporte de manera adecuada")
	clave1 := "Gato"
	clave2 := "Perro"
	clave3 := "Vaca"
	valor1 := "miau"
...
func TestConClavesNumericas(t *testing.T) {
	t.Log("Valida que el ABB funcione también con claves numéricas")
...
func TestPruebasDeVolumen(t *testing.T) {
	t.Log("Pruebas de volumen con un ABB")
...
func TestPruebasDeVolumenConClavesNumericas(t *testing.T) {
	t.Log("Pruebas de volumen con un ABB con claves numéricas")
	dic := diccionario.CrearABB[int, int](comparacionInt)
	cantidad := 10000
	for i := 0; i < cantidad; i++ {
		dic.Guardar(i, i)
...
func TestPruebasDeVolumenConClavesNumericasConBorrados(t *testing.T) {
	t.Log("Pruebas de volumen con un ABB con claves numéricas con borrados")
	dic := diccionario.CrearABB[int, int](comparacionInt)
	cantidad := 10000
	for i := 0; i < cantidad; i++ {
		dic.Guardar(i, i)
...
func TestPruebasDeVolumenConClavesNumericasConBorradosIntermedios(t *testing.T) {
	t.Log("Pruebas de volumen con un ABB con claves numéricas con borrados intermedios")
	dic := diccionario.CrearABB[int, int](comparacionInt)
	cantidad := 10000
	for i := 0; i < cantidad; i++ {
		dic.Guardar(i, i)
